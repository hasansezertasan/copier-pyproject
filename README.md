...
- Supply-chain security: CodeQL analysis, OpenSSF Scorecard (with README badge), a dependency-review gate that blocks PRs introducing high-severity vulnerabilities, active scanning (gitleaks, pip-audit, and Trivy for web images), and zizmor static analysis of the GitHub Actions workflows — a blocking prek/CI gate plus a Security-tab dashboard, backed by hardened, least-privilege, SHA-pinned workflows.
